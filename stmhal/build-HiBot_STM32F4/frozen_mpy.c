...
STATIC const mp_rom_obj_t const_table_data_onewire__lt_module_gt__OneWireError[0] = {
};
STATIC const mp_raw_code_t raw_code_onewire__lt_module_gt__OneWireError = {
    ...
    .data.u_byte = {
        ...
        .const_table = (mp_uint_t*)const_table_data_onewire__lt_module_gt__OneWireError,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 30,
        .n_obj = 0,
        .n_raw_code = 0,
