...
STATIC const mp_rom_map_elem_t pin_board_pins_locals_dict_table[] = {
  ...
  { MP_ROM_QSTR(MP_QSTR_LED_GREEN), MP_ROM_PTR(&pin_D12) },
  { MP_ROM_QSTR(MP_QSTR_LED_ORANGE), MP_ROM_PTR(&pin_D13) },
  { MP_ROM_QSTR(MP_QSTR_LED_RED), MP_ROM_PTR(&pin_D14) },
  { MP_ROM_QSTR(MP_QSTR_LED_BLUE), MP_ROM_PTR(&pin_D15) },
  { MP_ROM_QSTR(MP_QSTR_SW), MP_ROM_PTR(&pin_A0) },
};
